...
| --- | --- | --- | --- | --- |
| 2026-08-05 | Plan | [litestream-rsync-net](./plans/2026-08-05-litestream-rsync-net.md) | Archive-loss risk model + continuous Litestream replication to rsync.net (owner executing); safety layers 2–3 (env-based canonical DB path, delete-authority marker) spec'd for worker handoff | ❇️ Active |
| 2026-08-04 | Plan | [import-x-links](./plans/2026-08-04-import-x-links.md) | Paste-driven X-link import into real folders as stubs; `origin` gates all delete feeds until X re-observes; `--import-stubs` enrich discovery (PRs #11/#13, ADR 034). Acceptance passed live 2026-08-05 | 🌟 Complete |
| 2026-04-27 | Pause | [pause-pending-dada-stream-spec-layer](./tasks/2026-04-27-pause-pending-dada-stream-spec-layer.md) | Feature work paused while the dada.stream spec layer is consolidated. Scraper migrates to `dada.stream/components/x-sync/` once reconciliation against the new spec layer is done. See `~/projects/dada.stream/.project/plans/2026-04-26-consolidation-index.md`. | ⏸️ Suspended 2026-08 by owner for link-import + durability work |
