...
| 2026-08-04 | Plan | [import-x-links](./plans/2026-08-04-import-x-links.md) | Paste-driven X-link import into real folders as stubs; `origin` column keeps imports out of all delete feeds until X re-observes them. Merged (PR #11 + `f7034b4`, ADR 034) | 🟡 In Review |
